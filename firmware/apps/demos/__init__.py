...
# only on a button press (UP/DOWN to page, HOME to quit). Each demo's update()
# is called once to render a single frozen frame; there is no animation loop.
...
def render():
    # demos assume a cleared framebuffer; clear before the single update() call
